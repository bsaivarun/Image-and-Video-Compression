function Decoded_Ref_Frame = IntraDecode_YCbCr_Multi(zeroRun,Motion_Vector,Ref_Frame,Scaling_Factor,MultipleFrame)
    ...
    for i = 0:Block:FrameHeight-Block+1
        ...
        Corrected_Frame = Motion_Vector(flag,3);
            if (Corrected_Frame == 1)
                Ref_Frame_Y = Ref_Frame_Y_1;
                Ref_Frame_Cb = Ref_Frame_Cb_1;
                Ref_Frame_Cr = Ref_Frame_Cr_1;
            elseif (Corrected_Frame == 2)
                Ref_Frame_Y = Ref_Frame_Y_2;
                Ref_Frame_Cb = Ref_Frame_Cb_2;
                Ref_Frame_Cr = Ref_Frame_Cr_2;
            end
