function [Reconstructed_Y Reconstructed_Cb Reconstructed_Cr] = IntraDecode(Reconstructed_Data,Image,Scaling_Factor)
    
    [ImageHeight ImageWidth ImageDim] = size(Image);
    Block = 8;
    flag = 0;
    RLDec_Full = ZeroRunDec_2(Reconstructed_Data);
